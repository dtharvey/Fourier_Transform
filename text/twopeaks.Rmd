...
**Exercise 4.** Adjust the variables for peak 1 to a position of 40, a width of 5, and an area of 10, and adjust the variables for peak 2 to a position of 50, a width of 5, and an area of 10. Working in steps of +1 or +2 along the frequency axis, adjust the position for peak 1 from 40 to 60 and describe how the time domain spectrum changes.
